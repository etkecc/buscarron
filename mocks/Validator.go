...
func (_m *Validator) CNAME(_a0 string) bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for CNAME")
	}
...
// Email provides a mock function with given fields: _a0, _a1, _a2
func (_m *Validator) Email(_a0 string, _a1 string, _a2 ...net.IP) bool {
	...
	var r0 bool
	if rf, ok := ret.Get(0).(func(string, string, ...net.IP) bool); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_m *Validator) MX(_a0 string) bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for MX")
	}
...
func (_m *Validator) NS(_a0 string, _a1 ...string) bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for NS")
	}
