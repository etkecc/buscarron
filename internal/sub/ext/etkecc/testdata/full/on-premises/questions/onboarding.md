...
* Draupnir: [@draupnir:example.com](https://matrix.to/#/@draupnir:example.com) ([help](https://etke.cc/help/bots/draupnir/))
...
* Line: [@linebot:example.com](https://matrix.to/#/@linebot:example.com) ([help](https://etke.cc/help/bridges/beeper-line/))
* Linkedin: [@linkedinbot:example.com](https://matrix.to/#/@linkedinbot:example.com) ([help](https://etke.cc/help/bridges/mautrix-linkedin/))
...
1. You'll receive an invitation to [Migadu](https://migadu.com/)'s admin panel soon. Please check your inbox
...
4. Click **DNS Configuration**, then **Setup Instructions**
5. Follow the instructions to configure the DNS records for your domain
6. When you're done, click **Diagnostics** and confirm everything is configured correctly
