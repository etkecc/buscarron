...
var i18n map[string]map[string]string = map[string]map[string]string{
	"en": {
		...
		"q_delegation_details":  "To learn more about why these redirects are necessary and what the connection between the base domain (DOMAIN) and the Matrix domain (matrix.DOMAIN) is, read the following guide: https://etke.cc/help/faq#why-do-i-need-well-known-redirects-on-the-base-domain",
		...
		"q_telegram":            "please, go to https://my.telegram.org/apps and create a new app. Share the API ID and Hash with us",
		...
		"ps_matrixrooms":     "PS: To help with your first steps in the world of Matrix, we've built the [MatrixRooms.info](https://matrixrooms.info) search engine. You can use it to discover rooms over the Matrix Federation and find amazing communities you wish to join!",
