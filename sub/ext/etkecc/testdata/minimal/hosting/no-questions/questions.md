...
curl -X "POST" "https://api.hetzner.cloud/v1/firewalls" -H "Content-Type: application/json" -H "Authorization: Bearer $HETZNER_API_TOKEN_CLOUD" -d "{\"name\":\"example.com\",\"apply_to\":[{\"server\":{\"id\":$SERVER_ID}}],\"rules\":[{\"description\":\"SSH\",\"direction\":\"in\",\"port\":\"22\",\"protocol\":\"tcp\",\"source_ips\":[\"1.2.3.4/32\",\"5.6.7.8/32\"]}]}"
