...
var i18n map[string]map[string]string = map[string]map[string]string{
	"en": {
		...
		"as_postmoogle_2_turnkey": "Send the signature from command output to @support:etke.cc",
	...
	"ru": {
		...
		"as_postmoogle_2_turnkey": "Отправьте подпись из результата выполнения команды в @support:etke.cc",
	...
	"de": {
		...
		"as_postmoogle_2_turnkey": "Senden Sie die Signatur von der Befehlsausgabe an @support:etke.cc",
