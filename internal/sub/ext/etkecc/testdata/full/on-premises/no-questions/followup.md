...
Please make sure [all mandatory ports are open](https://etke.cc/order/status/#ports-and-firewalls), and that the following SSH key is added to **/home/user/.ssh/authorized_keys**: `ssh-todo TODO etke.cc`. Here's how:
...
4.  Set the correct permissions on the authorized_keys file: `chmod 600 /home/user/.ssh/authorized_keys`
5.  Set the correct permissions on the .ssh directory: `chmod 700 /home/user/.ssh`
6.  Set the correct ownership on the .ssh directory: `chown -hR user:user /home/user/.ssh`
